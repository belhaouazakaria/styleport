const items = [
  {
    ...
    a: "SayTwist aims to preserve meaning while changing tone or style. Always review output before high-stakes use.",
  },
  {
  ...
  {
    q: "Does SayTwist support many translation styles?",
